...
**ラジオのサウンドトラック**: [中を見る](https://scratch.mit.edu/projects/444581851/editor){:target="_blank"}
...
**サッカーの音**: [中を見る](https://scratch.mit.edu/projects/450870079/editor){:target="_blank"}
...
```blocks3
set volume to (80) %
set [ピッチ v] effect to (50) :: sound
set [左右にパン v] effect to (-100) :: sound
