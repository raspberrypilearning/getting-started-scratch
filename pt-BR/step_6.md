...
glide [1] secs to (posição aleatória v)
```
...
point in direction [90] // Clique em 90 e mova a seta para mudar o valor

point towards (ponteiro do mouse v)

(direction)

set rotation style [esquerda-direita v] // ou rotação completa ou não rotacionar
```
...
**Morcego giratório**: [Ver interior](https://scratch.mit.edu/projects/435704980/editor){:target="_blank"}
...
**Garota se movendo pelo Palco**: [Veja interior](https://scratch.mit.edu/projects/433535326/editor){:target="_blank"}
...
**Menina pulando**: [Veja interior](https://scratch.mit.edu/projects/433595822/editor){:target="_blank"}
...
set rotation style [não rotacionar v]
forever
move (5) steps
if on edge, bounce
```
...
**Jogador de futebol americano pulando**: [Ver interior](https://scratch.mit.edu/projects/433536479/editor){:target="_blank"}
...
set rotation style [rotação completa v]
forever
move (5) steps
if on edge, bounce
```
