...
**Performance campeã**: [Ver interior](https://scratch.mit.edu/projects/444673165/editor){:target="_blank"}
...
**Sons de futebol**: [Ver interior](https://scratch.mit.edu/projects/450870079/editor){:target="_blank"}
...
**Treino de banda**: [Ver interior](https://scratch.mit.edu/projects/451697380/editor){:target="_blank"}
...
```blocks3
set volume to (80) %
set [tom v] effect to (50) :: sound
set [balanço esquerda/direita v] effect to (-100) :: sound
...
+ O efeito `tom`{:class="block3sound"} controla o quão agudo ou grave é um som. Definir o tom para um valor mais alto também torna o som mais rápido. Você pode `mude o efeito tom para`{:class="block3sound"} valores entre `-360` (muito baixo) e `360` (muito alto).
